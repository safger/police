		...
		<div class="content-wrapper">
			...
			<div class="box box-default collapsed-box">
		            ...
		            <div class="box-body">
			             ...
			             <div class="comment-text" style="margin: 5px 20px;font-weight: bolder;font-size: 12px">
	                      <span class="username">
	               		  ...
	               		  <div class="col-xs-6"> 
		                  	 ...
		                  	 <select  id="sdepartment" class="form-control select2" style="width: 150px;float: left;"> 
								    	<option value="0">请选择</option> 
									  	<c:forEach var="list" items="${oragenizeAll }"> 
									  		<option value="${list.fuid }">${list.fullname }</option>
									  	</c:forEach>
								  </select>  
								   <div id="schild" style="float: left;width: 45%"  ></div>
		                </div>
		                <div class="col-xs-4">
		                  <span class="sp" >问题类型：</span> 	  <input type="radio" name="tp" class="minimal" checked="checked" value="2"> 所有 <input type="radio" name="tp" class="minimal"   value="1">&nbsp; 人员违规 &nbsp; <input type="radio" name="tp"  class="minimal" value="0" >&nbsp;视频问题&nbsp; 
		                </div>    
		             
		              </div> 
		              <div class="row" style="margin-top: 20px">
		               <div class="col-xs-6">
		                	  <span class="sp" >发生时间：</span>
		             	 ...
		             	 <div class="col-xs-4">
		                	 <span class="sp" style="float: left;display: block;" >问题简述： &nbsp;&nbsp;</span>
		                	 <select class="form-control" style="width:100%"
									name="sdescription" id="sdescription_2"><option
										value="-1">请选择</option>
									<option value="003001">玩手机</option>
									<option value="003002">睡觉</option>
									<option  value="003003">坐姿不正</option>
									<option value="003004">单人审讯</option>
									<option value="003005">抽烟</option>
									<option value="003006">无人看管</option>
									<option value="003009">其他</option>
									<option value="004006">网络异常</option>
									<option value="004005">监控地址错误</option>
									<option value="004001">视频模糊</option>
									<option value="004002">级联取流失败</option> 
									<option value="004003">无视频信号</option>
									<option value="004004">黑屏</option>
									</select>
		              ...
		              <div class="row" style="margin-top: 20px">
		                    <div class="col-xs-6">
		               	 <span class="sp" >是否处理：</span>  <input type="radio" name="scl" class="minimal" checked="checked" value="2"> 所有 <input type="radio" name="scl" class="minimal"   value="1">&nbsp; 已处理&nbsp; <input type="radio" name="scl"  class="minimal" value="0" >&nbsp;未处理&nbsp;
		               </div>
		              </div> 
		              <div class="row" style="margin-top: 20px" > 
...
$(function() {
    ...
    var template = Handlebars.compile(tpl);
	 ...
	 table = $('#newAttributeTable').dataTable( { 
        ...
        "ajax": "<%=basePath%>backstage/inspector/getDate.html",
        "columns": [{ "data": null, 
