				...
				<div class="box box-default collapsed-box">
		            ...
		            <div class="box-body">
		              <div class="row" style="margin-top: 20px">
		                  <div class="col-xs-9">
		                  <span class="sp" >迟到早退：</span> 	  <input type="radio" name="tp" class="minimal"   value="入场">&nbsp; 迟到 &nbsp; <input type="radio" name="tp"  class="minimal" value="出场" >&nbsp;早退&nbsp; 
		                </div>  
...
$(function() {
    ...
    var template = Handlebars.compile(tpl);
	 ...
	 table = $('#newAttributeTable').dataTable( { 
        ...
        "ajax": "<%=basePath%>backstage/traffic/getDataLate.html",
        "columns": [{ "data": null, 
