										...
										<div class="panel-body">
											<form role="form" id="myform">
												<div class="box-body">
													...
													<div class="form-group">
														<label >是否职能部门</label> &nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="fax" class="minimal" value="0" checked="checked"   > 否&nbsp;&nbsp;<input class="minimal" type="radio" name="fax" value="1"    > 是 
													</div> 
													<div class="form-group">
				 ...
				 $.ajax({
					    url: "<%=basePath %>system/organize/update_show.html?id="+id+"&time="+new Date(),
							...
							success : function(data) {
								 ...
								 $("#myform").find("input[name='fax']").each(function(){
									 if($(this).val()==0){  
						  					$(this).iCheck('check'); 
						  				} 
						  				if($(this).val()==data.fax){  
						  					$(this).iCheck('check');
						  				} 
						  			})
							}
