...
<link rel="stylesheet" href="<%=basePath%>Bootstrap_AdminLTE_2.3.6/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
  ...
  <!--[if lt IE 9]>
  <script src="<%=basePath%>Bootstrap_AdminLTE_2.3.6/plugins/html5shiv.min.js"></script>
  <script src="<%=basePath%>Bootstrap_AdminLTE_2.3.6/plugins/respond.min.js"></script>
  <![endif]-->
...
<header class="main-header">
    ...
    <a href="<%=basePath %>backstage/index.html" class="logo">
      ...
      <span class="logo-lg"><b>廉政防疫</b> | 管理系统</span>
    </a>
            ...
            <ul class="dropdown-menu"> 
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>所属部门 ：${sessionScope.departmentname }</small>
                </p>
              </li>
              <!-- Menu Footer-->
